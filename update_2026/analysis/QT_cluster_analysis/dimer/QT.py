...
topology = '/hdnas/marcol/tau/polimeri-120/dimer/select/QT-clustering/my100/select_CA.pdb';
trajectory = '/hdnas/marcol/tau/polimeri-120/dimer/select/QT-clustering/my100/traj_100ps.xtc';
...
np.savetxt('/hdnas/marcol/tau/polimeri-120/dimer/select/QT-clustering/my100/QT_Clusters.txt', clusters_arr, fmt='%i')

# NMRcluster format. VMD interface
with open('/hdnas/marcol/tau/polimeri-120/dimer/select/QT-clustering/my100/QT_Visualization.log', 'wt') as clq:
...
final_df = df.sort_values(by=['counts'], ascending=False);

np.savetxt(r'/hdnas/marcol/tau/polimeri-120/dimer/select/QT-clustering/my100/clusters_counts.txt', final_df.values, fmt='%d');
