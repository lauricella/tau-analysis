...
topology = '/hdnas/marcol/tau/polimeri-120/pentamer/select/QT-clustering/my100/select_CA.pdb';
trajectory = '/hdnas/marcol/tau/polimeri-120/pentamer/select/QT-clustering/my100/traj_100ps.xtc';
...
np.savetxt('/hdnas/marcol/tau/polimeri-120/pentamer/select/QT-clustering/my100/QT_Clusters.txt', clusters_arr, fmt='%i')

# NMRcluster format. VMD interface
with open('/hdnas/marcol/tau/polimeri-120/pentamer/select/QT-clustering/my100/QT_Visualization.log', 'wt') as clq:
...
np.savetxt(r'/hdnas/marcol/tau/polimeri-120/pentamer/select/QT-clustering/my100/clusters_counts.txt', df.values, fmt='%d');
