...
topology = '/hdnas/marcol/tau/polimeri-120/monomer/select/QT-clustering/select_CA.pdb';
trajectory = '/hdnas/marcol/tau/polimeri-120/monomer/select/QT-clustering/traj_comp_align_vero_tagliato.xtc';
...
np.savetxt('/hdnas/marcol/tau/polimeri-120/monomer/select/QT-clustering/QT_Clusters.txt', clusters_arr, fmt='%i')

# NMRcluster format. VMD interface
with open('/hdnas/marcol/tau/polimeri-120/monomer/select/QT-clustering/QT_Visualization.log', 'wt') as clq:
...
np.savetxt(r'/hdnas/marcol/tau/polimeri-120/monomer/select/QT-clustering/clusters_counts.txt', df.values, fmt='%d');
